...
def draw_tile_panels():
    ...
    for i in range(len(tile_list)):
        tile_button = button.Button(SCREEN_WIDTH + (75 * button_col) + 50, (75 * button_row + 50) - scroll_d, tile_list[i], 1)
...
while run:
    ...
    if scroll_right and scroll < (MAX_COLS * TILE_SIZE) - SCREEN_WIDTH:
        scroll += 5 * scroll_speed
    if scroll_down and scroll_d < SCREEN_HEIGHT:
        scroll_d += 5 * scroll_speed
    if scroll_up and scroll_d > 0:
        scroll_d -= 5 * scroll_speed
